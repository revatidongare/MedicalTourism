					...
					<div class="row">
						<div class="col-md-12">
							...
							$query = "SELECT * FROM `appointment`";
                             ...
                             $dquery = "SELECT * FROM `doctor` where `id` = $docid";
                             include '../config.php';
                             ...
                             $pquery = "SELECT * FROM `patient_master` where `id` = $pid";
                             include '../config.php';
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="../assets/img/doctors/<?php echo $dresult['image']?>" alt="User Image"></a>
															<a><?php echo $dresult['name']?></a>
														</h2>
													</td>
													<td><?php echo $dresult['specialities']?></td>
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="../assets/img/patients/<?php echo $presult['image']?>" alt="User Image"></a>
															<a><?php echo $presult['name']?></a>
														</h2>
													</td>
													<td><?php echo $appointment['appointmentdate']?><span class="text-primary d-block">11.00 AM - 11.15 AM</span></td>
													<td>
