...
<?php include 'includes/head.php';?>
	<body>
		...
		<div class="main-wrapper">
          ...
          echo '<script> alert("plz select Doctor from home page..")</script>';
							...
							<div class="doctor-widget">
								<div class="doc-info-left">
									<div class="doctor-img">
										<img src="assets/img/doctors/<?php echo $result['image'];?>" class="img-fluid" alt="User Image">
									</div>
									<div class="doc-info-cont">
										<h4 class="doc-name"><?php echo $result['name'];?></h4>
										<p class="doc-speciality"><?php echo $result['specialities'];?></p>
										...
										<div class="clinic-details">
											<p class="doc-location"><i class="fas fa-map-marker-alt"></i> <?php echo $result['address'];?> <!-- <a href="javascript:void(0);">Get Directions</a> --></p>
								...
								<div class="doc-info-right">
									<div class="clini-infos">
										<ul>
											...
											<li><i class="far fa-comment"></i> <?php echo $result['experience'];?></li>
											<li><i class="fas fa-map-marker-alt"></i> <?php echo $result['city'];?></li>
											<li><i class="far fa-money-bill-alt"></i> <?php echo $result['fees'];?> </li>
										</ul>
									</div>
														...
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<a href="#/" class="name"><?php echo $result['college'];?></a>
																	<div><?php echo $result['qualification'];?></div>
																	<span class="time"><?php echo $result['yearofcompletion'];?></span>
																</div>
															</div>
														</li>
														<!-- <li>
